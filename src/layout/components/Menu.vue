...
onMounted(function () {
  ...
  Global.layout.menuSizeInfo.titleHeight = getElementHeight(".the-layout-menu .the-layout-menu-title", 50);
  Global.layout.menuSizeInfo.itemHeight = getElementHeight(".the-layout-menu .the-layout-menu-item", 44);
})
</script>
